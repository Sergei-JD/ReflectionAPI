package reflection_api.ex_001_reflection.methods;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (Method method : methods) {
            System.out.println(s + "Name: " + s3 + method.getName());
            System.out.println(s + "\tReturn type: " + s2 + method.getReturnType().getName());
            Class<?>[] paramTypes = method.getParameterTypes();
            System.out.print(s + "\tParam types:" + s2);
        ...
        try {
            ...
            System.out.println(s + "Age: " + s2 + cm.getAge());
        } catch (Exception ex) {
            ex.printStackTrace();
        }
